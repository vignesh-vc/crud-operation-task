  ...
  return (
    ...
    <tr className=" hover:bg-gray-50">
      ...
      <td className="p-4">
        ...
        <button onClick={() => onDelete(user._id)} className="mr-4" title="Delete">
          <svg
            xmlns="http://www.w3.org/2000/svg"
